...
def slice_y(save_path, npy):
    ...
    print(val.shape)
    print(test.shape)
    train_save = save_path + "train_y.npy"
    test_save = save_path + "test_y.npy"
    val_save = save_path + "val_y.npy"
    np.save(train_save, train)
    np.save(test_save, test)
    np.save(val_save, val)
...
del_file("../data/ready")
# 数据集切片
cfg_npy = np.load("../data/dataset/cfg.npy")
pls_npy = np.load("../data/dataset/pls.npy")
y_npy = np.load("../data/dataset/y.npy")
dfg_npy = np.load("../data/dataset/dfg.npy")
ast_npy = np.load("../data/dataset/ast.npy")
print(ast_npy.shape)
print(dfg_npy.shape)
print(cfg_npy.shape)
print(pls_npy.shape)
print(y_npy.shape)
slice("../data/ready/emb_", pls_npy)
slice("../data/ready/ast_", ast_npy)
slice("../data/ready/cfg_", cfg_npy)
slice("../data/ready/dfg_", dfg_npy)
slice_y("../data/ready/", y_npy)
